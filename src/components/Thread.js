...
const Thread = ({user, filteredThread, setOpenPopUp, getThreads, setInteractingThread}) => {
    ...
    const timePassed = moment().startOf('hours').fromNow(filteredThread.timestamp)
    ...
    const postLike = async () => {
        ...
        if(!hasBeenLikedByUser) { // if it is not liked by me and I like it -> it pushes a like in the array and my uuid as well
            ...
            try {
                ...
                console.log("Successful like", result)
                getThreads()
            } catch(error) {
                console.error(error)
            }
    ...
    return (
        <article className="feed-card">
            ...
            <div className="icons">
                ...
                <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
